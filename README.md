...
3. **Edit the `FPM.py` script and insert your personal Google email address and password. Ensure to use a secure password, such as the one generated by Google for use with email clients.**
